...
class IpaParse(object):
    ...
    def version(self):
        self._check()
        if 'Bundle versions string, short' in self.plist_info_list:
            return self.plist_info_list['Bundle versions string, short']
        return ''
    ...
    def NSAllowsArbitraryLoads(self):
        ...
        if 'NSAppTransportSecurity' in self.info_plist_data and \
                        'NSAllowsArbitraryLoads' in self.plist_info_list["NSAppTransportSecurity"]:
...
if __name__ == '__main__':
    ...
    print parse.Internalversion()
    print parse.UIDeviceFamily()
    print parse.UIFileSharingEnabled()
    print parse.UIBackgroundModes()
    print parse.UIRequiredDeviceCapabilities()
    print parse.NSAllowsArbitraryLoads()
    print parse.version()
