...
if __name__ == '__main__':
    #######
    # check one app
    # ipa_path = "/Users/summer-wj/code/svn/ljsg_for_idreamsky_20150928_resign.ipa"
    ...
    print excel_path
    ipa_folder = '/Users/alexander.zhang/Downloads/build/'
    # ipa_folder = '/Users/idreamsky/Music/iTunes/iTunes Media/Mobile Applications/'
    # ipa_folder = '/Users/idreamsky/Music/iTunes/iTunes Media/'
    print batch_check(ipa_folder, excel_path)

    #########
    # test check arcs
    # app_path = '/Users/idreamsky/Downloads/ipas/mg/Payload'
    # app = app_utils.get_executable_file(app_path)
